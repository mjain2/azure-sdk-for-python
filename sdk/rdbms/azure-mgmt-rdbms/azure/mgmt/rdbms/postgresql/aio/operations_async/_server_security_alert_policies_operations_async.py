...
class ServerSecurityAlertPoliciesOperations:
    ...
    async def get(
        ...
        :rtype: ~azure.mgmt.rdbms.postgresql.models.ServerSecurityAlertPolicy
        ...
        return deserialized
    get.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DBforPostgreSQL/servers/{serverName}/securityAlertPolicies/{securityAlertPolicyName}'}
    ...
    async def create_or_update(
        ...
        :type parameters:
         ~azure.mgmt.rdbms.postgresql.models.ServerSecurityAlertPolicy
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: The poller return type is ClientRawResponse, the
         direct response alongside the deserialized response
        :param polling: True for AsyncARMPolling, False for no polling, or a
         polling object for personal polling strategy
        :return: An instance of ServerSecurityAlertPolicy or
         ClientRawResponse<ServerSecurityAlertPolicy> if raw==True
        :rtype: ~~azure.mgmt.rdbms.postgresql.models.ServerSecurityAlertPolicy
         or
         ~msrest.pipeline.ClientRawResponse[~azure.mgmt.rdbms.postgresql.models.ServerSecurityAlertPolicy]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
    ...
    create_or_update.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DBforPostgreSQL/servers/{serverName}/securityAlertPolicies/{securityAlertPolicyName}'}
