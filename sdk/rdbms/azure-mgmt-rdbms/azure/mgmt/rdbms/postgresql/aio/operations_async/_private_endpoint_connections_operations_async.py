...
class PrivateEndpointConnectionsOperations:
    ...
    :ivar api_version: The API version to use for the request. Constant value: "2018-06-01-privatepreview".
    """
    ...
    def __init__(self, client, config, serializer, deserializer) -> None:
        ...
        self.api_version = "2018-06-01-privatepreview"
    ...
    async def create_or_update(
        ...
        :rtype: ~~azure.mgmt.rdbms.postgresql.models.PrivateEndpointConnection
         or
         ~msrest.pipeline.ClientRawResponse[~azure.mgmt.rdbms.postgresql.models.PrivateEndpointConnection]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
    ...
    create_or_update.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DBforPostgreSQL/servers/{serverName}/privateEndpointConnections/{privateEndpointConnectionName}'}
    ...
    async def delete(
        ...
        return await async_poller(self._client, raw_result, get_long_running_output, polling_method)
    delete.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DBforPostgreSQL/servers/{serverName}/privateEndpointConnections/{privateEndpointConnectionName}'}
    ...
    async def update_tags(
        ...
        return await async_poller(self._client, raw_result, get_long_running_output, polling_method)
    update_tags.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DBforPostgreSQL/servers/{serverName}/privateEndpointConnections/{privateEndpointConnectionName}'}
    ...
    def list_by_server(
        ...
        :rtype:
         ~azure.mgmt.rdbms.postgresql.models.PrivateEndpointConnectionPaged[~azure.mgmt.rdbms.postgresql.models.PrivateEndpointConnection]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
        ...
        return deserialized
    list_by_server.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DBforPostgreSQL/servers/{serverName}/privateEndpointConnections'}
