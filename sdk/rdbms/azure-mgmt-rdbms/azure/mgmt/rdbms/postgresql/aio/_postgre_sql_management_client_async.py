...
from .operations_async import LogFilesOperations
from .operations_async import ServerAdministratorsOperations
from .operations_async import LocationBasedPerformanceTierOperations
...
class PostgreSQLManagementClient(SDKClientAsync):
    ...
    def __init__(
        ...
        super(PostgreSQLManagementClient, self).__init__(self.config)
