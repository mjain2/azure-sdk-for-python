...
class FlexibleServersConfigurationsOperations:
    """FlexibleServersConfigurationsOperations async operations.
    ...
    def list_by_server(
        ...
        :rtype:
         ~azure.mgmt.rdbms.postgresql.flexibleservers.models.ConfigurationPaged[~azure.mgmt.rdbms.postgresql.flexibleservers.models.Configuration]
        ...
        return deserialized
    list_by_server.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DBForPostgreSql/flexibleServers/{serverName}/configurations'}
    ...
    async def get(
        ...
        :rtype:
         ~azure.mgmt.rdbms.postgresql.flexibleservers.models.Configuration or
        ...
        return deserialized
    get.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DBForPostgreSql/flexibleServers/{serverName}/configurations/{configurationName}'}
