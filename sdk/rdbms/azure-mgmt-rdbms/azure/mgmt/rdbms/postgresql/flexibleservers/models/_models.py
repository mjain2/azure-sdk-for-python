...
class ServerPropertiesVnetInjArgs(Model):
    ...
    def __init__(self, **kwargs):
        ...
        self.delegated_vnet_id = kwargs.get('delegated_vnet_id', None)
        self.delegated_subnet_name = kwargs.get('delegated_subnet_name', None)
        self.delegated_vnet_name = kwargs.get('delegated_vnet_name', None)
