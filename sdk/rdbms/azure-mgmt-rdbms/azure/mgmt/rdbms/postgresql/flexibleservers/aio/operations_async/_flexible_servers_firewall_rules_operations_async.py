...
class FlexibleServersFirewallRulesOperations:
    """FlexibleServersFirewallRulesOperations async operations.
    ...
    async def create_or_update(
        ...
        :rtype:
         ...
         ~msrest.pipeline.ClientRawResponse[~azure.mgmt.rdbms.postgresql.flexibleservers.models.FirewallRule]
