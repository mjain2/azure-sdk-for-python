...
class FlexibleServersCheckNameAvailabilityOperations(object):
    """FlexibleServersCheckNameAvailabilityOperations operations.
    ...
    def execute(
        ...
        :rtype:
         ~azure.mgmt.rdbms.postgresql.flexibleservers.models.NameAvailability
