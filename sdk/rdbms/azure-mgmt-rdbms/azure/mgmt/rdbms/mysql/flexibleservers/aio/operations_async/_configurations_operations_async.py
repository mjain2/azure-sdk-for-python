...
class ConfigurationsOperations:
    ...
    async def update(
        ...
        :return: An instance of Configuration or
         ClientRawResponse<Configuration> if raw==True
        :rtype: ~~azure.mgmt.rdbms.mysql.flexibleservers.models.Configuration
         or
         ~msrest.pipeline.ClientRawResponse[~azure.mgmt.rdbms.mysql.flexibleservers.models.Configuration]
    ...
    update.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DBForMySql/flexibleServers/{serverName}/configurations/{configurationName}'}
    ...
    async def get(
        ...
        return deserialized
    get.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DBForMySql/flexibleServers/{serverName}/configurations/{configurationName}'}
    ...
    def list_by_server(
        ...
        :rtype:
         ~azure.mgmt.rdbms.mysql.flexibleservers.models.ConfigurationPaged[~azure.mgmt.rdbms.mysql.flexibleservers.models.Configuration]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
        ...
        if raw:
            header_dict = {}
        deserialized = models.ConfigurationPaged(
            internal_paging, self._deserialize.dependencies, header_dict, async_command=internal_paging_async)

        return deserialized
    list_by_server.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DBForMySql/flexibleServers/{serverName}/configurations'}
