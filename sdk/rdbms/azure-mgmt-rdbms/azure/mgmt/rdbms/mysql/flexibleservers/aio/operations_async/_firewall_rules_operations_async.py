...
class FirewallRulesOperations:
    ...
    async def create_or_update(
        ...
        :return: An instance of FirewallRule or
         ClientRawResponse<FirewallRule> if raw==True
        :rtype: ~~azure.mgmt.rdbms.mysql.flexibleservers.models.FirewallRule
         or
         ~msrest.pipeline.ClientRawResponse[~azure.mgmt.rdbms.mysql.flexibleservers.models.FirewallRule]
    ...
    create_or_update.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DBForMySql/flexibleServers/{serverName}/firewallRules/{firewallRuleName}'}
    ...
    async def delete(
        ...
        return await async_poller(self._client, raw_result, get_long_running_output, polling_method)
    delete.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DBForMySql/flexibleServers/{serverName}/firewallRules/{firewallRuleName}'}
    ...
    async def get(
        ...
        :rtype: ~azure.mgmt.rdbms.mysql.flexibleservers.models.FirewallRule or
        ...
        return deserialized
    get.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DBForMySql/flexibleServers/{serverName}/firewallRules/{firewallRuleName}'}
    ...
    def list_by_server(
        ...
        :rtype:
         ~azure.mgmt.rdbms.mysql.flexibleservers.models.FirewallRulePaged[~azure.mgmt.rdbms.mysql.flexibleservers.models.FirewallRule]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
        ...
        if raw:
            header_dict = {}
        deserialized = models.FirewallRulePaged(
            internal_paging, self._deserialize.dependencies, header_dict, async_command=internal_paging_async)

        return deserialized
    list_by_server.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DBForMySql/flexibleServers/{serverName}/firewallRules'}
