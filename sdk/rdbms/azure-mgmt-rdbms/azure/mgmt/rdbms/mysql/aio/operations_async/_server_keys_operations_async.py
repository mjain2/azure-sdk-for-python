...
class ServerKeysOperations:
    ...
    def list_by_instance(
        ...
        :rtype:
         ~azure.mgmt.rdbms.mysql.models.ServerKeyPaged[~azure.mgmt.rdbms.mysql.models.ServerKey]
        ...
        return deserialized
    list_by_instance.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DBforMySQL/servers/{serverName}/keys'}
    ...
    async def get(
        ...
        :rtype: ~azure.mgmt.rdbms.mysql.models.ServerKey or
        ...
        return deserialized
    get.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DBforMySQL/servers/{serverName}/keys/{keyName}'}
    ...
    async def create_or_update(
        ...
        :param server_name: The name of the server.
        :type server_name: str
        :param key_name: The name of the MySQL Server key to be operated on
         (updated or created).
        :type key_name: str
        ...
        :return: An instance of ServerKey or ClientRawResponse<ServerKey> if
         raw==True
        :rtype: ~~azure.mgmt.rdbms.mysql.models.ServerKey or
         ~msrest.pipeline.ClientRawResponse[~azure.mgmt.rdbms.mysql.models.ServerKey]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
    ...
    create_or_update.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DBforMySQL/servers/{serverName}/keys/{keyName}'}
    ...
    async def delete(
        ...
        return await async_poller(self._client, raw_result, get_long_running_output, polling_method)
    delete.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DBforMySQL/servers/{serverName}/keys/{keyName}'}
